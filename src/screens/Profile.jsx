...
const Profile = () => {
  ...
  return (
    <div className="my-5 mx-10 lg:mx-60">
      <div className="text-3xl text-primary font-bold text-center py-5">
        Profile Details
      </div>
        ...
        <form className="flex flex-col py-10" onSubmit={handlesubmit}>
          ...
          <div className="">
            ...
            <ul className="mx-10 flex gap-2">
              {skills.map((skill) => (
                <li className="bg-slate-400 rounded w-fit my-2 px-3 py-2">
                  {skill}
                </li>
              ))}
            </ul>
          ...
          <button className="btn btn-priamry w-fit mx-10 mt-6" type="sumbit">
            change
          </button>
        </form>
      </div>
